...
const kolApp = {
        ...
        const htmls = this.kols.map(function (kol, index) {
            return `
                <tr>
                    ...
                    <td>${kol.phone}</td>
                    <td>
                        <a class="btnEdit" data-id="${index}" href="#">Sửa</a>
                        <a class="btnDel" data-id="${index}" href="#">Xóa</a>
                    </td>
                </tr>
            `
        })
    ...
    start: function() {
        ...
        btnClose.onclick = function() {
            $('.overlay_del').classList.remove('active')
        }
        ...
        const btnDels = $$('.btnDel')
        btnDel.onclick = function() {
            $('.overlay_del').classList.add('active')
            const btnDelAction = $('.modal_del__btn')
            const id = btnDelAction
